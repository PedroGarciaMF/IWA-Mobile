...
const ProductsService = {
  getProducts: async function (limit = 50) {
    ...
    //console.log(`ProductService::getProducts: ${global.API_BASE}/products?limit=${limit}`);
    try {
      const response = await axios.get(
        `${global.API_BASE}/products?limit=${limit}`,
      );
  ...
  getProduct: async function (pid = '') {
    ...
    //console.log(`ProductService::getProducts: ${global.API_BASE}/products/${pid}`);
    try {
